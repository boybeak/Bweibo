...
public class ErrorInfo {
    ...
    private static String sSuccessMsg = "{\"error\":\"success\",\"error_code\":0,\"request\":\"\"}";

    private static ErrorInfo sSuccessInfo = parse(sSuccessMsg);
    ...
    public static ErrorInfo getSuccessInfo () {
        return sSuccessInfo;
    }
